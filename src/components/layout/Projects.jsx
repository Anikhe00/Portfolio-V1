...
function Projects() {
  return (
    ...
    >
      ...
      <ul className="w-full h-fit flex md:grid lg:grid md:grid-cols-2 lg:grid-cols-2 flex-col content-start gap-[2rem] lg:gap-[3rem] self-stretch overflow-visible">
